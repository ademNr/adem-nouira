...
import { ExternalLink, Github, Smartphone, Monitor, Zap } from 'lucide-react';

const projects = [
    {
        title: 'GitForje',
        description: 'Create github repo project documentation and generate your README in seconds',
        image: '/gitforjecap.png',
        tech: ['Next.JS', 'React.js', 'NodeJS', 'ExpressJS'],
        category: 'Web App',
    ...
    {
        title: 'Cubelytics',
        description: 'E-commerce AI product analysis platform. Enter your product and see the market viability.',
        image: '/cubelytics.png',
        tech: ['Next.js', 'Node.js', 'MongoDB', 'React js'],
        category: 'Web App',
        color: 'from-blue-400 to-purple-500',
        bgColor: 'bg-blue-50 dark:bg-blue-900/20',
        icon: <Monitor size={24} className="text-blue-500" />
    ...
    {
        title: 'IntakeAI',
        description: 'macros tracker using ai, snap your plate to track your macros, analytics and more...',
        image: '/intake.png',
        tech: ['Flutter'],
        category: 'Mobile App',
    ...
    },
    {
        ...
        tech: ['Socket.io', 'Flutter', 'Node js'],
        category: 'Real-time',
    ...
    },
    {
        ...
        description: 'Digital QR menu with live order tracking and waiter app.',
        image: '/resto.png',
        tech: ['UI/UX', 'Figma'],
        category: 'Mobile App',
        color: 'from-orange-400 to-red-500',
