...
export default function Hero() {
    ...
    const latestProject = {
        title: 'GitForje - README Generator',
        description: 'Create project documentation and generate your README in seconds...',
        category: 'Web App',
        tech: ['Next.js', 'React.js', 'NodeJS', 'AI'],
        image: '/project2.jpg',
    ...
    return (
        <section className="min-h-screen relative overflow-hidden bg-gradient-to-br from-slate-50 via-white to-blue-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
            {/* Background Elements */}
                ...
                <div className="grid md:grid-cols-2 gap-12 items-center min-h-[60vh]">
                    ...
                    >
                        ...
                        <div className="space-y-4">
                            ...
                            >
                                Top rated <span className="font-semibold text-orange-500">frontend developer</span> crafting digital experiences that people love to use.
                            </motion.p>
                        </div>
                            ...
                            >
                                ...
                                <div className="flex items-start gap-4 mb-4">
                                    <div className={`w-12 h-12 rounded-xl ${latestProject.bgColor} flex items-center justify-center group-hover:scale-110 transition-transform duration-300`}>
                                        <img
                                            src="/gitforjelogo.png" // Replace with your actual CV preview image
                                            alt="CV Preview"
                        ...
                        >
                            <motion.a
                                ...
                                href="mailto:ademnr2@gmail.com?subject=Project Inquiry&body=Hi Adem,%0D%0A%0D%0AI&apos;d like to discuss a project with you.%0D%0A%0D%0ABest regards"
                        ...
                        <div className="relative">
                            ...
                            >
                                ...
                                <div className="absolute inset-2 rounded-full overflow-hidden bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-700 dark:to-gray-800">
                                    <img
                                        src="/mypic.jpg"
                                        alt="Adem - Frontend Developer"
                                        className="w-full h-full object-cover transition-all duration-700 hover:scale-110 filter grayscale hover:grayscale-0"
                                        style={{
